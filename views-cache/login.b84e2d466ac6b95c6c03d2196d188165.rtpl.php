...
<div class="login-box">
  ...
  <div class="login-box-body">
    <h1 class="login-box-msg"><b>Admin</b></h1>
    ...
    <div class="social-auth-links text-center">
      ...
      <a href="https://www.facebook.com/" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign in using
        Facebook</a>
      <a href="https://mail.google.com/" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign in using
        Google+</a>
    </div>
    <!-- /.social-auth-links -->
