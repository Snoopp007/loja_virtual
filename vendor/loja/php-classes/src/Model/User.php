	...
	public static function getForgot($email, $inadmin = true)
	{
	     ...
	     else
	     {
	         ...
	         else
	         {
	             ...
	             if ($inadmin === true) {
	                 $link = "http://www.topphones.com.gh/admin/forgot/reset?code=$result";
	             } else {
	                 $link = "http://www.topphones.com.gh/forgot/reset?code=$result";
	             } 
	             $mailer = new Mailer($data['desemail'], $data['desperson'], "Redefinir senha da Loja Topphones", "forgot", array(
	                 "name"=>$data['desperson'],
	                 "link"=>$link
	             )); 
	             $mailer->send();
